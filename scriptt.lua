function Kick()
    game.Players.LocalPlayer:Kick(game.Players.LocalPlayer.Name.."请购买白名单") 
end
...
local signatures = loadstring(game:HttpGet("https://pastebin.com/raw/aK1ja1rv"))();
-----------------------------------------------------------\\加载函数//-----------------------------------------------------------
local REN = {
...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local bin = UITab1:section("『☯".."公告☯』",true)
--
local Player = Player1:section("基础功能",true)
--
local rgb = rgb1:section("光影",true)
--
local scp = scp1:section("Scp：角设扮演",true)
--
...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    bin:Label("忍脚本疯狂优化中...")
    bin:Label("忍脚本最新版本:"..banbe.."")
    bin:Label("更新日志:")

    bin:Label("v2.1 极速传奇自动重生/刷等级等")
...
function shuaxinlb(zji)
    local studio = loadstring(game:HttpGet("https://pastebin.com/raw/dk95iEkt"))();
    if studio == nil then
    else
    loadstring(studio)
    end
...
Tab:Button("星月交辉 V3[破解]", function()
    ...
    game.Players.LocalPlayer.UserId = "2914515246"
    ...
    game.Players.LocalPlayer.Name = "4v5n7n"
    game.Players.LocalPlayer.Character.Name = "4v5n7n"
    use_load('https://raw.githubusercontent.com/xiaobaijiaoben/-X-/main/%E5%B0%8F%E7%99%BD1L.lua')
    --客户版
    --小白功能已恢复
    end)
    ...
    game.Players.LocalPlayer.Character.Name = "sjqgduf2"
    use_load("https://shz.al/~Dashutong")
    end)
    
    Tab:Button("静新[破解]", function()
    game.Players.LocalPlayer.Name = "ffjfjcjid"
    game.Players.LocalPlayer.Character.Name = "ffjfjcjid"
    use_load("https://shz.al/FJxA")
    end)
...
print(Important_functions,signatures)
end
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
end
Important_Whitelist = ([[
...
local UserId_REN_123fa98 = game.Players.LocalPlayer.UserId
local Api_REN_123fa98 = game:HttpGet("https://users.roblox.com/v1/users/"..UserId_REN_123fa98)
local REN_name = string.match(Api_REN_123fa98,'name":"(.-)",')
local REN_displayName = string.match(Api_REN_123fa98,'displayName":"(.-)"')

if Ren_Name["游戏名1"] == Ren_Name["游戏名2"] and Ren_Name["游戏名3"] == REN_displayName and Ren_Name["游戏名1"] == REN_name and Ren_Name["游戏名2"] == REN_name then
...
if Ren_zt == true then
 if R == "忍脚本交流群:139341298" then
    scripts()
 elseif REN_name == "123fa98" or REN_name == "cmhehebeb" then
    scripts()
 else
    Kick()
 end
